// import { collectionSugarRelatedJournals, db } from "@/lib/firebase/collections";
// import { doc, getDocs, writeBatch } from "firebase/firestore";

// export async function addDataField() {
//   try {
//     const snapshot = await getDocs(collectionSugarRelatedJournals);
...
//       batch.update(doc(db, "sugarRelatedJournals", item.id), {
